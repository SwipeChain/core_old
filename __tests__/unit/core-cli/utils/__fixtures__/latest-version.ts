    ...
    versions: {
        "2.5.24": {
            ...
            dependencies: {
                ...
                "@swipechain/core-blockchain": "^2.5.24",
                "@swipechain/core-container": "^2.5.24",
                "@swipechain/core-database-postgres": "^2.5.24",
                "@swipechain/core-event-emitter": "^2.5.24",
                "@swipechain/core-exchange-json-rpc": "^2.5.24",
                "@swipechain/core-forger": "^2.5.24",
                "@swipechain/core-logger-pino": "^2.5.24",
                "@swipechain/core-p2p": "^2.5.24",
                "@swipechain/core-snapshots": "^2.5.24",
                "@swipechain/core-state": "^2.5.24",
                "@swipechain/core-transaction-pool": "^2.5.24",
                "@swipechain/core-utils": "^2.5.24",
                "@swipechain/core-wallet-api": "^2.5.24",
                "@swipechain/core-webhooks": "^2.5.24",
                "@swipechain/crypto": "^2.5.24",
    ...
    versions: {
        "2.5.0-next.10": {
            ...
            dependencies: {
                ...
                "@swipechain/core-blockchain": "^2.5.0-next.10",
                "@swipechain/core-container": "^2.5.0-next.10",
                "@swipechain/core-database-postgres": "^2.5.0-next.10",
                "@swipechain/core-event-emitter": "^2.5.0-next.10",
                "@swipechain/core-exchange-json-rpc": "^2.5.0-next.10",
                "@swipechain/core-forger": "^2.5.0-next.10",
                "@swipechain/core-logger-pino": "^2.5.0-next.10",
                "@swipechain/core-p2p": "^2.5.0-next.10",
                "@swipechain/core-snapshots": "^2.5.0-next.10",
                "@swipechain/core-state": "^2.5.0-next.10",
                "@swipechain/core-transaction-pool": "^2.5.0-next.10",
                "@swipechain/core-utils": "^2.5.0-next.10",
                "@swipechain/core-wallet-api": "^2.5.0-next.10",
                "@swipechain/core-webhooks": "^2.5.0-next.10",
                "@swipechain/crypto": "^2.5.0-next.10",
                "@oclif/command": "^1.5.16",
                "@oclif/config": "^1.13.2",
                "@oclif/plugin-autocomplete": "^0.1.1",
                "@oclif/plugin-commands": "^1.2.2",
