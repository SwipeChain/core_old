...
import { Command } from "@packages/core/src/commands/manager-status";
...
describe("StatusCommand", () => {
    it("should throw if the process does not exist", async () => {
        await expect(cli.execute(Command)).rejects.toThrow('The "swipechain-manager" process does not exist.');
    });
