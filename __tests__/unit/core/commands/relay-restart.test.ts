...
describe("RestartCommand", () => {
    it("should throw if the process does not exist", async () => {
        ...
        await expect(cli.execute(Command)).rejects.toThrowError('The "swipechain-relay" process does not exist.');
    ...
    it("should throw if the process is stopped", async () => {
        ...
        await expect(cli.execute(Command)).rejects.toThrowError('The "swipechain-relay" process is not running.');
