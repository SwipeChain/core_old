...
describe("StopCommand", () => {
    it("should throw if the process does not exist", async () => {
        ...
        await expect(cli.execute(Command)).rejects.toThrowError('The "swipechain-forger" process does not exist.');
    ...
    it("should throw if the process entered an unknown state", async () => {
        ...
        await expect(cli.execute(Command)).rejects.toThrowError(
            'The "swipechain-forger" process has entered an unknown state.',
        );
    ...
    it("should throw if the process is stopped", async () => {
        ...
        await expect(cli.execute(Command)).rejects.toThrowError('The "swipechain-forger" process is not running.');
