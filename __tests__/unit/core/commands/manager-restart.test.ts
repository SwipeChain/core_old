...
import { Command } from "@packages/core/src/commands/manager-restart";
...
describe("RestartCommand", () => {
    it("should throw if the process does not exist", async () => {
        ...
        await expect(cli.execute(Command)).rejects.toThrowError('The "swipechain-manager" process does not exist.');
    ...
    it("should throw if the process is stopped", async () => {
        ...
        await expect(cli.execute(Command)).rejects.toThrowError('The "swipechain-manager" process is not running.');
