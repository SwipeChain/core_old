...
import { Enums } from "@swipechain/crypto";
...
describe("WorkerPool.initialize", () => {
    it("should create workers", () => {
        const workerCount = 5;
        const cryptoPackages = [{ typeGroup: 2, packageName: "@swipechain/core-magistrate-crypto" }];
        ...
        expect(worker.loadCryptoPackage).toBeCalledWith("@swipechain/core-magistrate-crypto");
