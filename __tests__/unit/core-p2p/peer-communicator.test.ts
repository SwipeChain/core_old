...
import {Container, Utils as KernelUtils} from "@swipechain/core-kernel";
import { constants } from "@swipechain/core-p2p/src/constants";
import {
    PeerPingTimeoutError,
    PeerStatusResponseError,
    PeerVerificationFailedError,
} from "@swipechain/core-p2p/src/errors";
import { Peer } from "@swipechain/core-p2p/src/peer";
import { PeerCommunicator } from "@swipechain/core-p2p/src/peer-communicator";
import { PeerVerificationResult } from "@swipechain/core-p2p/src/peer-verifier";
import { replySchemas } from "@swipechain/core-p2p/src/schemas";
import { Blocks, Identities, Managers, Transactions, Utils } from "@swipechain/crypto";
import delay from "delay";

jest.mock("@swipechain/core-p2p/src/socket-server/utils/get-codec", () => ({
