...
import { getPeerConfig } from "@swipechain/core-p2p/src/socket-server/utils/get-peer-config";
...
beforeEach(() => {
    ...
    version = "3.0.9";
    appPlugins = [
        { package: "@swipechain/core-api", options: {} },
        { package: "@swipechain/core-webhooks" },
    ...
    serviceProviders = {
        "@swipechain/core-api": coreApiServiceProvider,
        "@swipechain/core-webhooks": coreWebhooksServiceProvider,
        "@swipechain/core-p2p": coreP2PServiceProvider,
    };
...
describe("getPeerConfig", () => {
    it("should omit a plugin if it is storing the [port] at the root of the options", () => {
        ...
        delete result.plugins["@swipechain/core-api"];
    ...
    it("should return plugins enabled value if enabled property is listed in configuration", () => {
        ...
        result.plugins["@swipechain/core-api"].enabled = false;
        expect(getPeerConfig(app)).toEqual(result);
    });
});
