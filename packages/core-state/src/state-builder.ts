import { Repositories } from "@swipechain/core-database";
import { Application, Container, Contracts, Enums, Services, Utils as AppUtils } from "@swipechain/core-kernel";
    ...
    private verifyWalletsConsistency(): void {
        ...
        for (const wallet of this.walletRepository.allByAddress()) {
            if (
                ...
                // Example:
                //          https://explorer.swipechain.org/transaction/608c7aeba0895da4517496590896eb325a0b5d367e1b186b1c07d7651a568b9e
                //          Results in a negative balance (-2 SXP) from height 93478 to 187315
