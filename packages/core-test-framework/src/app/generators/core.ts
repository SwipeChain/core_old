import { Types } from "@swipechain/core-kernel";
...
export class CoreGenerator extends Generator {
    ...
    private writeEnvironment(): void {
        ...
        if (this.options.core.environment) {
            ...
            copyFileSync(require.resolve("@swipechain/core/bin/config/testnet/.env"), filePath);
        }
    }
    ...
    private writeApplication(): void {
        ...
        if (this.options.core.app) {
            ...
            copyFileSync(require.resolve("@swipechain/core/bin/config/testnet/app.json"), filePath);
        }
    }
