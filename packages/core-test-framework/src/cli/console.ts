import { Application, ApplicationFactory, Commands, Container, Services, Utils } from "@swipechain/core-cli";
...
export class Console {
    ...
    private reset(): void {
        this.args = [];
        this.flags = this.useDefaultFlags ? { token: "swipechain", network: "testnet" } : {};
    }
