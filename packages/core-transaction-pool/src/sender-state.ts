import { Container, Contracts, Enums, Providers, Services } from "@swipechain/core-kernel";
import { Handlers } from "@swipechain/core-transactions";
import { Crypto, Interfaces, Managers } from "@swipechain/crypto";
...
export class SenderState implements Contracts.TransactionPool.SenderState {
    ...
    @Container.tagged("plugin", "@swipechain/core-transaction-pool")
