import { Models } from "@swipechain/core-database";
import { Container, Contracts, Providers, Types, Utils } from "@swipechain/core-kernel";
import { Blocks, Interfaces, Managers } from "@swipechain/crypto";
...
export class SnapshotDatabaseService implements Database.DatabaseService {
    ...
    @Container.tagged("plugin", "@swipechain/core-snapshots")
    private readonly configuration!: Providers.PluginConfiguration;

    @Container.inject(Container.Identifiers.PluginConfiguration)
    @Container.tagged("plugin", "@swipechain/core-database")
