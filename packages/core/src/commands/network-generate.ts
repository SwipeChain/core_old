import { Commands, Container, Contracts, Services } from "@swipechain/core-cli";
import { Crypto, Identities, Interfaces, Transactions, Utils, Managers, Blocks } from "@swipechain/crypto";
import Joi from "joi";
...
export class Command extends Commands.Command {
    ...
    private generateApp(options: Options): any {
        ...
        if (includeDynamicFees) {
            app.core.plugins.find((plugin) => plugin.package === "@swipechain/core-transaction-pool").options = {
                dynamicFees,
            };

            app.relay.plugins.find((plugin) => plugin.package === "@swipechain/core-transaction-pool").options = {
                dynamicFees,
            };
        }
