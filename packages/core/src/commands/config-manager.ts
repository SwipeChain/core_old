...
export class Command extends Commands.Command {
    ...
    private async generateManagerSection(options: Options): Promise<any> {
        const result: any = {
            plugins: [
                {
                    package: "@swipechain/core-logger-pino",
                },
                {
                    package: "@swipechain/core-database",
                },
                {
                    package: "@swipechain/core-snapshots",
                },
                {
                    package: "@swipechain/core-manager",
                },
            ],
        };
        ...
        if (Object.keys(packageOptions.plugins).length) {
            result.plugins.find((plugin) => plugin.package === "@swipechain/core-manager").options = packageOptions;
        }
