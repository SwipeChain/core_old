...
export abstract class ServiceProvider {
    ...
    public alias(): string | undefined {
        if (this.packageManifest) {
            return this.packageManifest.get("swipechain.core.alias");
        }
    ...
    public dependencies(): Kernel.PluginDependency[] {
        if (this.packageManifest) {
            return this.packageManifest.get("swipechain.core.dependencies", []);
        }
    ...
    public async required(): Promise<boolean> {
        if (this.packageManifest) {
            return this.packageManifest.get("swipechain.core.required", false);
        }
